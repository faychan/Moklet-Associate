                    ...
                    <?php foreach($alumni as $data): ?>
                        <tr style="cursor:pointer;" group="hidden">
                            ...
                            <td class="text-center ">
                                <a onClick="delete_alert()" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i></a>
                            </td>
                        </tr>
                        <?php ?>
                    <?php endforeach; ?>
...
<script>
    ...
    function delete_alert() {
        swal({
            ...
            function(isConfirm){
                if (isConfirm) {
                    window.location = "<?php  echo base_url(); ?>index.php/home/delete_data/<?php echo $data->id_diri .'/'.
                        $data->nama .'/'. $data->foto; ?>";
                    return true;
                }else{
                    return false;
